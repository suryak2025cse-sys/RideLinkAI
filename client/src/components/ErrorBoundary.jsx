    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4">
          <div className="app-card max-w-md w-full p-8 rounded-3xl text-center space-y-4 shadow-lg bg-white border border-slate-200">
            <div className="w-12 h-12 bg-rose-100 text-rose-600 rounded-2xl flex items-center justify-center mx-auto">
              <AlertTriangle className="w-6 h-6" />
            </div>
            <h2 className="text-2xl font-black text-slate-900">Something went wrong</h2>
            <p className="text-slate-500 text-sm font-semibold">
              An unexpected render issue occurred. Click below to reload the app instantly.
            </p>
            <button
